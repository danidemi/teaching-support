...
/**
 * `/courses/:courseId/quizzes` (QUIZ-DASHBOARD-001): lists the quizzes
 * belonging to one course, with delete and replace-file actions. No
 * upload-to-create here — that's QTI-22-IMPORT's screen; this one only
 * manages quizzes that already exist.
 *
